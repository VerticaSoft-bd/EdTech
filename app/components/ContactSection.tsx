                        ...
                        <div className="relative z-10 space-y-10 group-hover/card:translate-y-[-5px] transition-transform duration-500">
                            ...
                            <div className="flex flex-col items-center gap-4 border-b border-gray-100 pb-8 text-center">
                                ...
                                <div className="space-y-1.5">
                                    <h2 className="text-2xl md:text-4xl font-black text-[#181C25] tracking-tight">Our Information</h2>
                                    <p className="text-[12px] md:text-[14px] text-gray-500 font-bold uppercase tracking-[0.2em] opacity-70">Youth Instructory Center</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-start gap-4 p-5 rounded-2x border border-gray-100 bg-white hover:border-[#6C5DD3]/20 hover:bg-gray-50 transition-all duration-300 col-span-1 md:col-span-2 group/contact">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[12px] font-black text-gray-400 uppercase tracking-widest leading-none">Office Address</span>
                                        <span className="text-[15px] md:text-[17px] font-bold text-gray-800 leading-relaxed">৪০৩/এ, খিলগাঁও চৌরাস্তা (ফিউচার কমার্স কলেজ এর নীচতলা), ঢাকা-১২১৯</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 bg-white hover:border-[#6C5DD3]/20 hover:bg-gray-50 transition-all duration-300 group/contact">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[12px] font-black text-gray-400 uppercase tracking-widest leading-none">Email Us</span>
                                        <a href={`mailto:${siteSettings?.contactEmail || 'info@youthinstructory.com'}`} className="text-[14px] md:text-[16px] font-bold text-gray-800 hover:text-[#6C5DD3] transition-colors truncate max-w-[150px] md:max-w-none">{siteSettings?.contactEmail || 'info@youthinstructory.com'}</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 bg-white hover:border-[#6C5DD3]/20 hover:bg-gray-50 transition-all duration-300 group/contact">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[12px] font-black text-gray-400 uppercase tracking-widest leading-none">Call Us</span>
                                        <a href={`tel:${siteSettings?.contactPhone || '+880 1234 567 890'}`} className="text-[14px] md:text-[16px] font-bold text-gray-800 hover:text-[#4A72FF] transition-colors">{siteSettings?.contactPhone || '+880 1234 567 890'}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
