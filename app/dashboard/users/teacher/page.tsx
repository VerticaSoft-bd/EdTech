    ...
    return (
        <div className="space-y-6 animate-in fade-in zoom-in-95 duration-200">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-[#1A1D1F]">Teacher Accounts</h2>
                    <p className="text-sm text-gray-500 mt-1">Manage instructors, lecturers, and their assigned courses.</p>
                </div>
