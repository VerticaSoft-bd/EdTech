    ...
    return (
        <div className="space-y-6 animate-in fade-in zoom-in-95 duration-200">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-[#1A1D1F]">Staff Accounts</h2>
                    <p className="text-sm text-gray-500 mt-1">Manage platform moderators, support agents, and billing staff.</p>
                </div>
